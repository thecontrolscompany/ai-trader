CREATE TYPE "public"."asset_class" AS ENUM('stock', 'etf', 'bond', 'crypto', 'option');
CREATE TYPE "public"."signal_direction" AS ENUM('long', 'short', 'neutral');
...
ALTER TABLE "trades" ADD CONSTRAINT "trades_ai_signal_id_ai_signals_id_fk"
  FOREIGN KEY ("ai_signal_id") REFERENCES "public"."ai_signals"("id")
