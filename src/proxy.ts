...
const PROTECTED = ["/scan", "/trades", "/accounts", "/dashboard", "/auto-trade", "/activity", "/admin", "/home", "/api/scan", "/api/trades", "/api/accounts", "/api/auto-trade", "/api/deploy", "/api/portfolios", "/api/admin"];
